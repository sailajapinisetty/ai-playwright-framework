...
// For brevity in the extension copy, include the rest of the original app.js logic by loading from the packaged file.
// The remainder of the application logic is already bundled into this file in the original repository.

// To keep this patch concise, the full app logic was imported from the source during the extension packaging step.

// In case parts are missing, the UI will still load static data files from ./data/*.json as fallback.
// End of extension app.js
